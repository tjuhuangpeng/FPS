...
public class AHFloatingButton extends ImageButton {
    ...
    public AHFloatingButton(Context context) {
        this(context, null);
    }

    public AHFloatingButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public AHFloatingButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    void init(Context context, AttributeSet attributeSet) {
        TypedArray attr = context.obtainStyledAttributes(attributeSet, R.styleable.AHFloatingButton, 0, 0);
        mColorNormal = attr.getColor(R.styleable.AHFloatingButton_fab_colorNormal, getColor(android.R.color.holo_blue_dark));
        mColorPressed = attr.getColor(R.styleable.AHFloatingButton_fab_colorPressed, getColor(android.R.color.holo_blue_light));
        mColorDisabled = attr.getColor(R.styleable.AHFloatingButton_fab_colorDisabled, getColor(android.R.color.darker_gray));
        mSize = attr.getInt(R.styleable.AHFloatingButton_fab_size, SIZE_NORMAL);
        mIcon = attr.getResourceId(R.styleable.AHFloatingButton_fab_icon, 0);
        mTitle = attr.getString(R.styleable.AHFloatingButton_fab_title);
        mStrokeVisible = attr.getBoolean(R.styleable.AHFloatingButton_fab_stroke_visible, true);
        attr.recycle();
    ...
    void updateBackground() {
        ...
        LayerDrawable layerDrawable = new LayerDrawable(
                new Drawable[]{
                        getResources().getDrawable(mSize == SIZE_NORMAL ? R.drawable.ahlib_common_fab_bg_normal : R.drawable.ahlib_common_fab_bg_mini),
